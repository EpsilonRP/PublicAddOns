...
C.defaultGlobalSettings = {
	global = { ["debug"] = false, sprintKey = "LSHIFT", sprintMode = "dual", alwaysFixSprintJump = false, extendedFlightDetection = true, lastRunVersion = false, useDefaultForNewChar = false },
	runOnceFixBindings = {},
