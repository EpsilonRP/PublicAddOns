...
local function showSalvagerMenu()
	if not salvagerMenu then
		...
		salvagerMenu = CreateFrame("Frame", "Arcanum_DataSalvager", UIParent, "BackdropTemplate")
		...
		salvagerMenu.SF.backdrop = CreateFrame("FRAME", "$parent_Backdrop", salvagerMenu.SF, "BackdropTemplate")
