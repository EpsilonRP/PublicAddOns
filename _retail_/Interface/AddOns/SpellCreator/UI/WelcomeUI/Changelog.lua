...
local versions = {
	...
	},
	{
		...
		changes = {
			...
			"Buncha New Actions for stuff that used to be blocked!",
			"Talking Heads! #Fancy",
			"UnitPowerBars!",
			...
			{
				"ArcSpells, and each action inside an ArcSpell, can now have conditions attached using our new Conditions System & Editor!",
				...
				"These icons will display if they have any conditions set by lighting up the button, along with showing a quick preview of the conditions in the tooltip when mousing over it.",
				" ",
			...
			"",
			"Over 25+ New Actions, Including Previously Restricted / Blocked Functions",
			{
			...
			"New TalkingHead & UnitPowerBar Actions, thanks to skylar!",
			{
				...
				"UnitPowerBar:",
				{
					"These are UI status bars you can use for various things, like tracking simulated quest percentages, current RP health / power, or.. probably way more than I can think of!",
					"There's a load of different styles/appearances to use as well, including some custom ones!",
				},
			},
			"",
			...
			"Arc's HasAura XAPI call, and thus the Toggle Aura function & Action, now check for 'HARMFUL' auras as well, not just 'HELPFUL' ones. (NOTE: Still does not detect any 'hidden' auras).",
			...
			"Fixed '/arc' slash commands being mostly non-functional. Now supports spell inputs in /arc cast as well.",
			...
			"Added a healthy serving of Liber-Tea.",
			" ",
		}
	},
	{
