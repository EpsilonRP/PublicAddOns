...
do
	-- function addPopupTriggerToPhaseData(commID: string, radius: number, style: integer, x: number, y: number, z: number, colorHex: any, mapID: integer, options: SparkTriggerDataOptions, overwriteIndex: any, sparkType: number|SparkTypes)
