...
PhaseToolkit.MapIconInfo={["MinimapButtonPos"]={
    ["minimapPos"]=207
},}
...
PhaseToolkit.NPCCustomMainFrameCloseButton=CreateFrame("Button",nil,PhaseToolkit.NPCCustomiserMainFrame,"UIPanelCloseButton")
PhaseToolkit.NPCCustomMainFrameCloseButton:SetSize(30,30)
PhaseToolkit.NPCCustomMainFrameCloseButton:SetPoint("TOPRIGHT",PhaseToolkit.NPCCustomiserMainFrame,"TOPRIGHT",0,0)
PhaseToolkit.NPCCustomiserMainFrame:Hide()
