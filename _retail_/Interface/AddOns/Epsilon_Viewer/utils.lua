...
utils.Window = function(parent, width, height, title)
	...
	frame.texture:SetTexture(assetsFolder .. "\\EpsiIndexBG", "MIRROR", "MIRROR")
	...
	frame.titlePanel.texture:SetTexture(assetsFolder .. "\\EpsiIndexTitleBoxMain", "CLAMP", "CLAMP")

	frame.closeBtn:SetText('')
	frame.closeBtn:SetNormalTexture(assetsFolder .. "\\CLOSE-BUTTON")
	frame.closeBtn:SetHighlightTexture(assetsFolder .. "\\CLOSE-HOVER-BUTTON")
