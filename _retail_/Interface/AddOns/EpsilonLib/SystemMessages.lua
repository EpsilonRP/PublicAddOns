	...
	if event == "CHAT_MSG_ADDON" then
		...
		if prefix == "EPSILON_OBJ_INFO" or prefix == "EPSILON_OBJ_SEL" then
			...
			if sender == self or string.gsub(self, "%s+", "") then
				...
				local go = EpsiLib.GameObject._new(guid, entry, name, filedataid, x, y, z, orientation, rx, ry, rz, HasTint, red, green, blue, alpha, spell, scale, groupLeader, objType, saturation, rGUIDLow, rGUIDHigh);
